function pp = manu_pp(fname, da, opts)
...
for i = 1 : n_agg
    f_ad = strcat('D:\Hamed\PRS\CND\PhD\TEM\NRC\NRC1\Analysis\NRC\Samples1_Dec20\Selected_Images\Temp\Test2\Results\ATEMS\RAWDAT_PP\', fname{i}, '.csv'); % Making file address
