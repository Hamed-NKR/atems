...
- images/ : TEM images of biomass smoke particles sampled near Kamloops, BC, collected during daytime and nighttime.
...
## Usage Examples
   ...
   \[~, imgs, pixsizes\] = load_imgs
        may also use load_imgs_v3 which can manually extract image scales.
...
I thank Dr. Jason Olfert (UofA), Dr. Allan Bertram (UBC), Dr. Joel Corbin (NRC), and Dr. Arash Naseri (UofA) for their intellectual and logistical support. Samples were collected by Mang Guan and imaged/analyzed by the author. Thermophoretic sampler for particle collection was developed by Steven Zimmerman. The data processing was conducted under Dr. Steven Rogak and Dr. Timothy Sipkens' supervision. TEM imaging was performed at UBC Bioimaging Facilities.
